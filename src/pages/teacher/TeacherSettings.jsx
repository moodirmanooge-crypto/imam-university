...
import { updateTeacherProfile } from "../../firebase/teacherProfile";
...
export default function TeacherSettings() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("Profile-kaaga waa la cusboonaysiiyay!");
      setNewPassword("");
      setConfirmPassword("");
      // Pushes the new name/photo into the shared auth session so the
      // sidebar avatar/name (DashboardLayout) reflects it immediately —
      // without this, the sidebar keeps showing the old placeholder
      // icon and name until the next login.
      if (refreshUser) refreshUser({ fullName: fullName.trim(), photo: photoPreview });
    } catch (err) {
  ...
  return (
    <div>
      ...
      >
        {/* Username — locked, shown read-only */}
        ...
        {/* Photo — fixed square size, not full width */}
